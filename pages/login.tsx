...
const Login = () => {
    ...
    return <main className='h-screen w-full flex flex-row'>
        ...
        <aside className="debug w-6/12 flex flex-col justify-center items-center bg-[#722e9a]">
            <div className="debug flex flex-col w-2/4 h-3/5 justify-center items-center gap-11 bg-slate-50 rounded-lg shadow-2xl">
            ...
            <span className='hover:text-[#facb2e] hover:scale-105 hover:cursor-pointer text-gray-500'>Registrarse</span>
            </div>
